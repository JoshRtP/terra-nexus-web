...
It addresses the financial, risk, and strategic questions that portfolio managers,
...
What are our environmental assets, credit positions, or program outcomes worth —
...
* Scenario analysis for credit price trajectories, registry integrity, and buyer demand shifts
...
* Program-level financial modeling (yield, cost, revenue, risk)
...
* Any named engagement or portfolio examples
* Depth of public disclosure

## Externally Time-Sensitive Information Requiring Future Research

* Current carbon credit price benchmarks by type, registry, and vintage
* Current guidance on carbon asset accounting under IFRS, GAAP, or SEC disclosure rules
* Current integrity risks by registry and credit type affecting valuations
