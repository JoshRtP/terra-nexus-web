...
claims programs. It addresses the access and strategy decisions that environmental
...
and Scope 3 supply chain claim programs — and what commitments, risks, and
...
* Credit sourcing strategy, counterparty assessment, and contract structure guidance
...
* Scope 3 inset program evaluation and pathway selection
* Claim structure and communication requirements analysis
...
* Scope 3 claim pathway options analysis
...
* Any named client or engagement examples to include
* Depth of public disclosure for capabilities in this offering

## Externally Time-Sensitive Information Requiring Future Research

* Current state of VCM integrity standards (e.g., ICVCM Core Carbon Principles, VCMI claims framework)
* Current Scope 3 guidance updates (GHG Protocol, SBTi FLAG, LEAP, land-sector removals guidance)
* Current registry-specific requirements for the credit types referenced above
* Regulatory developments affecting VCM access (jurisdictional carbon pricing interactions)
